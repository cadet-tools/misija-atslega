...
1. Atver `admin.html`.
2. Ja augšā rāda `Supabase nav pieslēgts`, pārbaudi `supabase-config.js`.
3. Ja rāda pieslēgšanās lauku, ievadi Supabase Auth admin e-pastu un paroli un spied `Pieslēgties`.
4. Sagatavo KP, bildes un trases.
5. Spied `Saglabāt`.
6. Skolēni atver `index.html` un redz tās pašas bildes no Supabase.
